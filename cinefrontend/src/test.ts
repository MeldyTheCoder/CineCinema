...
const films: TFilm[] = [
  ...
  },
  {
    ...
    ageRestriction: TAgeRestiction.SIXTEEN_PLUS,
    durationSeconds: 6600, // 1 час 50 минут
    coverUrl:
    ...
    price: 370,
    activeDateFrom: "2025-03-08",
    activeDateTo: "2025-04-05",
  },
  {
    id: 4,
    title: "Мистер Бин",
    ...
    ageRestriction: TAgeRestiction.ZERO_PLUS,
    durationSeconds: 5400, // 1 час 30 минут
    coverUrl:
      "https://avatars.mds.yandex.net/get-kinopoisk-image/1599028/07126f53-52e5-4feb-ac07-05167cfee824/600x900",
    price: 300,
    activeDateFrom: "2025-03-12",
    activeDateTo: "2025-04-20",
  },
  {
    id: 5,
    title: "Начало",
...
const halls: THall[] = [
  {
    id: 1,
    title: "IMAX Galaxy",
    priceFactor: 1.5, // Повышенная цена за премиальный формат,
    seatsX: 10,
    seatsY: 5,
  },
  {
    ...
    priceFactor: 2.0, // VIP-зал с удобными креслами и обслуживанием,
    seatsX: 5,
    seatsY: 10,
  },
  {
    ...
    priceFactor: 1.0, // Обычный зал без доплат
    seatsX: 5,
    seatsY: 20,
  },
];
...
const announces: TAnnounce[] = [
  {
    id: 1,
    coverUrl: "https://platform.vox.com/wp-content/uploads/sites/2/chorus/uploads/chorus_asset/file/16221040/parabellumcover.jpg?quality=90&strip=all&crop=7.8362408553742,0,84.327518289252,100",
    title: "Джон Уик",
